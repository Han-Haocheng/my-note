...
比较大小：$\forall(x,y)\in D$ 有 $f(x,y)\leq g(x,y)\Rightarrow \iint_{D}f\mathrm{d}\delta\leq\iint_{D}g \mathrm{d}\delta$


$f(x,y)≥0$ 时 $D₁⊂D₂ ⇒ ∬_{D₁}f(x,y)dσ$ ≤ $∬_{D₂}f(x,y)dσ$
例 1 比较 I₁、I₂、I₃.
I₁ = ∬_{x²+y²≤1} (x²+y²)dxdy, I₂ = ∬_{|x|+|y|≤1} 2|xy|dσ
I₃ = ∬_{|x|+|y|≤1} (x²+y²)dxdy.
