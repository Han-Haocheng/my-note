...
#类型/数学/定义 一般高阶偏导数：$$\frac{\partial \frac{\partial z}{\partial x}}{\partial x}=\frac{\partial^{2} z}{\partial x}=f''_{xx}(xy)=z''_{x x}$$


#类型/数学/定义 高阶混合偏导数：$\frac{\partial \frac{\partial z}{\partial x}}{\partial y}$ ，$\frac{\partial \frac{\partial z}{\partial y}}{\partial x}$
