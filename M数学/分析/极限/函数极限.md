...
#类型/数学/定义 函数极限(有限数) ![[数学/attachments/202410211008.svg]]
...
#类型/数学/公式/极限 $\lim_{x\to 0}\frac{\sin x}{x}=1$ 
...
#类型/数学/公式/极限 $\lim_{ x \to \infty }\left( 1+\frac{1}{x} \right)^x=e$
