...
- 将[[CS计算机应用/操作系统/Linux系统/src/ex-2/testlab2.c]]在修改过的Linux 0.11上编译运行，显示的结果即内核程序的得分。满分50%
- 只要至少一个新增的系统调用被成功调用，并且能和用户空间交换参数，可得满分
- 将脚本[[CS计算机应用/操作系统/Linux系统/src/ex-2/testlab2.sh]]在修改过的Linux 0.11上运行，显示的结果即应用程序的得分。满分30%
- 实验报告，20%
