...
- 通过`插入`选项卡
	1. 单击`插入`选项卡→`插图`组-> `SmartArt`![[计算机科学/计算机基础/attachments/Pasted image 20241020191736.png|30]]命令
	2. 选择需要插人的SmartArt图形
- 通过`内容`版式
	1. 单击占位符->`插入SmartArt图形`![[计算机科学/计算机基础/attachments/Pasted image 20241020191716.png|30]]按钮
	2. 选择需要插人的SmartArt图形
- 通过快捷菜单
	1. 右击占位符
